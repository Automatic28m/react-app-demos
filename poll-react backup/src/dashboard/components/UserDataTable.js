...
function UserDataTable() {
    ...
    const fetchData = async () => {
        const blank = "null";
        let url = `http://localhost:8080/api/user/pagingAndSortingUser/${currentPage}/${pageSize}/${sortBy}/${sort}/${searchTerm}`;

        if (searchTerm == "") {
            url = `http://localhost:8080/api/user/pagingAndSortingUser/${currentPage}/${pageSize}/${sortBy}/${sort}/${blank}`
        };
