            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                        ...
                        <div className='flex flex-col mb-3 px-2 py-1'>
                            <b className="text-3xl text-accent">Pollanswer.org</b>
                            <b className='text-lg'>Management System</b>
                        </div>
                        ...
                        <div className='flex flex-row gap-3 items-center px-2 py-1'>
                            <div className="avatar online placeholder">
                                <div className="bg-neutral text-neutral-content rounded-full w-14">
                                    {/* <span className='text-2xl'>{userData.username.substring(2, 0)}</span> */}
                                </div>
                            </div>
                            <div>
                                <b className='text-lg'>{userData.username}</b>
                                <p className='text-md'>#{userData.id}</p>
                            </div>
                        </div>
